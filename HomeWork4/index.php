...
$name="Кот";
$prof="Мурлыка";
$city_country="Амстердам, Нидерланды";
$e_mail="cat@cat.org";
$tel="+1234567890";
$skills=[
			[
...
$experience = 	[
					[
                    	"name"=>"Фронтэнд разработчик",
                        "description"=>"Разрабатывал фронтэнд",
                        "date_from"=>strtotime("01.01.2015"),
                        "date_to"=>time()
                    ],
                    [
                    	"name"=>"Веб разработчик",
                        "description"=>"Разрабатывал веб-сайты",
                        "date_from"=>strtotime("01.03.2012"),
                        "date_to"=>strtotime("31.12.2014")
                    ],
                    [
                    	"name"=>"Дизайнер",
                        "description"=>"Рисовал",
                        "date_from"=>strtotime("01.06.2010"),
                        "date_to"=>strtotime("28.02.2012")
                    ]
				];
?>
<!DOCTYPE html>
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i>
          	<?php echo date('M Y', $experience[$i]["date_from"])?>
            <?php echo " - "?>
            <?php echo date('M Y', $experience[$i]["date_to"])?>
          </h6>
